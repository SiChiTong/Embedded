...
void HF_Led_Key_Init(void)
{
    ...
    {
        RCC_AHB1PeriphClockCmd(RCC_LED0 , ENABLE);
    ...
    {
        RCC_AHB1PeriphClockCmd(RCC_LED3 , ENABLE);
    ...
    {
        RCC_AHB1PeriphClockCmd(RCC_LED4 , ENABLE);
    ...
    {
        RCC_AHB1PeriphClockCmd(RCC_LED5 , ENABLE);
    ...
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;//normal output mode
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100M
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//pull up
    if ( KEY_Init_Num++ < KEY_NUM)      //if enable KEY0, initialize this
    {
        RCC_AHB1PeriphClockCmd(RCC_KEY0 , ENABLE);
    ...
    {
        RCC_AHB1PeriphClockCmd(RCC_KEY1 , ENABLE);
    ...
    {
        RCC_AHB1PeriphClockCmd(RCC_KEY2 , ENABLE);
    ...
    {
        RCC_AHB1PeriphClockCmd(RCC_KEY4 , ENABLE);
