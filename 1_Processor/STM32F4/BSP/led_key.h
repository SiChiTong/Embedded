...
/*******************LED0************************/
#define RCC_LED0            RCC_AHB1Periph_GPIOG
#define GPIO_LED0           GPIOG
#define GPIO_LED0_Pin       GPIO_Pin_15
...
//#define RCC_LED0            RCC_AHB1Periph_GPIOD
//#define GPIO_LED0           GPIOD
//#define GPIO_LED0_Pin       GPIO_Pin_14
//#define LED0_ON()           GPIO_ResetBits(GPIO_LED0 , GPIO_LED0_Pin)
//#define LED0_OFF()          GPIO_SetBits(GPIO_LED0 , GPIO_LED0_Pin)
//#define LED0_TOGGLE()       (GPIO_LED0->ODR) ^= GPIO_LED0_Pin
	
/*******************LED1************************/
#define RCC_LED1            RCC_AHB1Periph_GPIOD
#define GPIO_LED1           GPIOD
#define GPIO_LED1_Pin       GPIO_Pin_13
...
/*******************LED2************************/
#define RCC_LED2            RCC_AHB1Periph_GPIOD
...
/*******************LED3************************/
#define RCC_LED3            RCC_AHB1Periph_GPIOD
#define GPIO_LED3           GPIOD
#define GPIO_LED3_Pin       GPIO_Pin_15
...
/*******************LED4************************/
#define RCC_LED4            RCC_AHB1Periph_GPIOA
...
/*******************LED5************************/
#define RCC_LED5            RCC_AHB1Periph_GPIOA
...
/*******************KEY0************************/
#define RCC_KEY0            RCC_AHB1Periph_GPIOC
#define GPIO_KEY0           GPIOC
#define GPIO_KEY0_Pin       GPIO_Pin_14
#define READ_KEY0           GPIO_ReadInputDataBit(GPIO_KEY0  , GPIO_KEY0_Pin)
/*********************************************/

/*******************KEY1************************/
#define RCC_KEY1            RCC_AHB1Periph_GPIOC
...
/*******************KEY2************************/
#define RCC_KEY2            RCC_AHB1Periph_GPIOA
#define GPIO_KEY2           GPIOA
#define GPIO_KEY2_Pin       GPIO_Pin_4
#define READ_KEY2           GPIO_ReadInputDataBit(GPIO_KEY2  , GPIO_KEY2_Pin)
/*********************************************/

/*******************KEY3************************/
#define RCC_KEY3            RCC_AHB1Periph_GPIOA
...
/*******************KEY4************************/
#define RCC_KEY4            RCC_AHB1Periph_GPIOA
...
/*******************KEY5*b***********************/
#define RCC_KEY5            RCC_AHB1Periph_GPIOA
...
/*******************BEEP************************/
#define RCC_BEEP            RCC_AHB1Periph_GPIOB
#define GPIO_BEEP           GPIOB
#define GPIO_BEEP_Pin       GPIO_Pin_9
#define BEEP_ON()           GPIO_SetBits(GPIO_BEEP , GPIO_BEEP_Pin)
#define BEEP_OFF()          GPIO_ResetBits(GPIO_BEEP , GPIO_BEEP_Pin)
#define BEEP_TOGGLE()       (GPIO_BEEP->ODR) ^= GPIO_BEEP_Pin
/*********************************************/

#define LED_NUM         1       //the number of enable LED 0--6
#define KEY_NUM         0       //the number of enable KEY 0--6
